...
export class AppComponent {
  ...
  ngOnInit() {
    ...
    this.instance.importDefaults({ anchors: ["Right", "ContinuousLeft"] });
  }
  _addEndPoints2(
    id: string,
    ...
    this.instance.addTargetSelector(`#${id}`, {
      ...this.targetEndpoint,
      ...{
        anchor: "ContinuousLeft",
        uuid: id + targetAnchors[0],
        scope: "target_scope"
      }
    });
  }
  ...
  manageNode(id: string) {
    setTimeout(() => {
      this.instance.manageAll(`#${id}`);
      this._addEndPoints2(id, ["Right"], ["ContinuousLeft"]);
    });
  }
}
